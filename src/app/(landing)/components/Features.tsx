        ...
        <div className="container mx-auto mt-20 mb-20">
            ...
            <div className="flex flex-wrap justify-center pt-10">
                <div className="md:w-1/4 p-5">
                    ...
                    <p className="text-sm">With AI at its core, LIKHO streamlines the website creation process, making it quicker and more intuitive than ever before. No need to worry about writing complexities; chatGPT will take care of that for you.</p>
                </div>
                <div className="md:w-1/4 p-5">
                    <div className="mb-2 text-2xl">📒</div>
