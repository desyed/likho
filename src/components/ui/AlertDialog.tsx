...
>(({ className, children, ...props }, ref) => (
 <AlertDialogPortal>
  ...
  <AlertDialogPrimitive.Content
   ...
   {...props}
  >
   <div className="w-full h-full relative gap-4 flex flex-col">{children}</div>
  </AlertDialogPrimitive.Content>
 </AlertDialogPortal>
));
...
const AlertDialogAction = React.forwardRef<
 ...
 React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Action> & {
  actionType?: "primary" | "destructive";
 }
>(({ className, actionType = "primary", ...props }, ref) => {
 const v = actionType as VariantProps<typeof buttonVariants>["variant"];
 return (
